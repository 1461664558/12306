...
public class TicketCarriage {
    ...
    public TicketCarriage(Integer id, String tickettype, BigDecimal rate, BigDecimal proportion, Date creattime, Date updatatime, String creatuser, String updatauser, Date deletetime, String con1, String con2, String con3, String con4, String con5) {
        this.id = id;
